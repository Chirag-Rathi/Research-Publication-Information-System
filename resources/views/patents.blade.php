  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="panel panel-primary">
        <div class="panel-heading text-center">Patent information</div>
        <div class="panel-body main_panel">
          {!! Form::open(['url' => 'patent/submit','method' => 'post']) !!}
<!-- FIRST BOX.....................................IPR AUTHORS -->
            <div class="panel panel-primary authappend">
              <div class="panel-heading text-center">Patent Authors information : </div>
              <div class="panel-body authorinfo">
                  ...
                  <div class="form-group col-md-12 col-sm-12">
                   <button type="button" class="btn-success text-center pull-right"style="margin-top: 6px; width: 10%; border-radius: 8px; padding: 4px;box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); " onclick="addauthe()">Add Patent Co-Author</button>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="form-group">
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
            ...
            <div class="row">
             <div class="form-group col-md-4 col-sm-4">
                <label class="control-label" for="yearRangeEnd">Date of Patent published :</label>
                <div>
              ...
              <div class="form-group col-sm-4 col-md-4">
                <label>Upload Soft copy here...</label>
                <div>
